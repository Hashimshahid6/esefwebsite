                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-group editor" name="description" id="description">{{old('description')}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" id="facebook_link" value="{{old('facebook_link')}}" name="facebook_link" placeholder="Enter Facebook Link">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Twitter</label>
                                            <input type="url" class="form-control" id="twitter_link" value="{{old('twitter_link')}}" name="twitter_link" placeholder="Enter Twitter Link">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" id="linkedin_link" value="{{old('linkedin_link')}}" name="linkedin_link" placeholder="Enter Linkedin Link">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" id="instagram_link" value="{{old('instagram_link')}}" name="instagram_link" placeholder="Enter Instagram Link">
