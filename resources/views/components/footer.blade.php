            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-info">
                        <h3>Elementary & Secondary Education Foundation<br>
                            Khyber Pakhtunkhwa</h3>
                        <p class="pb-3"><em></em></p>
                        <p>Plot No.20, Street No.13, Sector E-8,<br>
                            Phase-7, Hayatabad, Peshawar <br>
                            <br><br>
                ...
                <div class="col-lg-4 col-md-3 footer-links">
                    <ul style="line-height:4px;">
                        <li>
                            <h4>Useful Links</h4>
                        </li>
                        <li><i class="bx bx-chevron-right"></i> <a href="https://www.gcs-feasibility.esef.org.pk/"
