        ...
        <section id="" class="about">
            <div class="container mb-5" style="margin-top: 80px !important">
							<div class="row d-flex">
								...
								<div class="col-6">
									<img src="{{ url('/') }}/uploads/nfealp/alp-minister.jfif" class="img-fluid" style="padding:50px 10px 10px 20px;">
									<img src="{{ url('/') }}/uploads/nfealp/alp-training.jfif" class="img-fluid" style="padding:50px 10px 10px 20px;">
									<img src="{{ url('/') }}/uploads/nfealp/alp-bags.jfif" class="img-fluid" style="padding:50px 10px 10px 20px;">
									<img src="{{ url('/') }}/uploads/nfealp/alp-class.jfif" class="img-fluid" style="padding:50px 10px 10px 20px;">
								</div>
							</div>
							  
								@if($list)								
								<div class="tabs">
									<p>For ALP Material, please go to <a href="{{ url('/') }}/downloads/nfealp">Downloads Section</a>.</p>
